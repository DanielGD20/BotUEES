$(document).ready(function() {
	...
	var mybot = '<div class="chatCont" id="chatCont">'+
								'<div class="bot_profile">'+
									'<img src="assets/img/bot2.png" class="bot_p_img">'+
									'<div class="close">'+
								...
								'<div class="chatForm" id="chat-div">'+
									...
									'</div>'+
									'<input type="text" id="chat-input" autocomplete="off" placeholder="Escribe tu mensaje..."'+ 'class="form-control bot-txt"/>'+
								'</div>'+
							'</div><!--chatCont end-->'+
							...
							'<div class="profile_div">'+
								'<div class="row">'+
									'<div class="col-hgt">'+
										'<img src="assets/img/bot2.png" class="img-circle img-profile">'+
									'</div><!--col-hgt end-->'+
									'<div class="col-hgt">'+
										'<div class="chat-txt">'+
